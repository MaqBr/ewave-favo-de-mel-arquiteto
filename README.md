...
Esse recurso implementa o padrão Event Sourcing que utiliza o EventStore, um banco de banco de dados para persistência de eventos. Os eventos são armazenados e obtidos do EventStore disponível na URL:
